...
class Powerfolio_Common_Settings
{
    ...
    public static function get_upgrade_message( $source = '' )
    {
        ...
        if ( $source == 'elementor' ) {
            $raw .= '<p style="margin-bottom: 10px; font-size: 12px; font-style: italic; margin-top: 5px;">' . __( 'Get access to the Special Grids, Grid Builder, extra CSS effects, several customization options and much more!', 'powerfolio' ) . '</p>';
        } else {
            $raw .= '<p style="margin-bottom: 10px; font-size: 12px; font-style: italic; margin-top: 5px;">' . __( 'Get access to the Special Grids, extra CSS effects, several customization options and much more!', 'powerfolio' ) . '</p>';
        }
